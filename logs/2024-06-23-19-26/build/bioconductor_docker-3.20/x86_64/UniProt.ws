...
trying URL 'https://p3m.dev/cran/__linux__/jammy/2024-06-13/src/contrib/hms_1.1.3.tar.gz'
Content type 'binary/octet-stream' length 100190 bytes (97 KB)
==================================================
downloaded 97 KB

trying URL 'https://p3m.dev/cran/__linux__/jammy/2024-06-13/src/contrib/httpcache_1.2.0.tar.gz'
Content type 'binary/octet-stream' length 62181 bytes (60 KB)
==================================================
downloaded 60 KB

trying URL 'https://p3m.dev/cran/__linux__/jammy/2024-06-13/src/contrib/progress_1.2.3.tar.gz'
Content type 'binary/octet-stream' length 86380 bytes (84 KB)
==================================================
downloaded 84 KB

trying URL 'https://p3m.dev/cran/__linux__/jammy/2024-06-13/src/contrib/rjsoncons_1.3.0.tar.gz'
Content type 'binary/octet-stream' length 1495788 bytes (1.4 MB)
==================================================
downloaded 1.4 MB

trying URL 'https://bioconductor.org/packages/3.20/bioc/src/contrib/UniProt.ws_2.45.0.tar.gz'
Content type 'application/x-gzip' length 241961 bytes (236 KB)
==================================================
downloaded 236 KB
...
* creating tarball
packaged installation of ‘UniProt.ws’ as ‘UniProt.ws_2.45.0_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (UniProt.ws)

The downloaded source packages are in
	‘/tmp/Rtmpp665L2/downloaded_packages’
